...
--block_size=512 --line_by_line --per_gpu_train_batch_size=16 --gradient_accumulation_steps=2 --do_eval \
--evaluate_during_training --eval_data_file=data/eval_text.txt --per_gpu_eval_batch_size=16 --max_steps=100000 \
